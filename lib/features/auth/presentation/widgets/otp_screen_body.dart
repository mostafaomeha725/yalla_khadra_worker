...
import 'package:yallakhadra/features/auth/presentation/widgets/otp_card.dart';

class OtpScreenBody extends StatelessWidget {
  const OtpScreenBody({required this.email, super.key});
    ...
    return BlocProvider<ForgotPasswordCubit>(
      ...
      child: Container(
        ...
        child: SafeArea(
          child: Column(
            children: [
              const ForgetPasswordTopBar(title: AuthStrings.verifyCodeTitle),
              Expanded(
